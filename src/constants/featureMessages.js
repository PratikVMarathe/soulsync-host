export const FEATURE_MESSAGES = {
  AI_GUIDE: 'AI Guide is not connected yet. Once it is live, you will be able to ask deeper questions here.',
  CONTINUE_LEARNING: 'Continue Learning is still using preview content. Real lessons and progress tracking will be connected soon.',
